...
{
	pPlayer->ADD_GOSSIP_ITEM_EXTENDED_ID(0, GOSSIP_ITEM_codebox_1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1, "", 0, true);
	pPlayer->ADD_GOSSIP_ITEM_ID(GOSSIP_ICON_CHAT, GOSSIP_ITEM_codebox_2, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
