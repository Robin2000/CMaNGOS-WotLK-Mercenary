...
//=====================================
/*! \brief MD5 Support allows checksums to be computed for images, determing if they have changed since
    the album was saved out, and if so need to be loaded and rescaled.
 */
//=====================================
...
/*
May - 2004
Modified by Thomas "temas" Muldowney to use standard STL strings rather than
QT QStrings.
*/
...
// the MD5 context.
  ...
  MD5              (unsigned char *string,unsigned int string_length); // digest string, finalize
