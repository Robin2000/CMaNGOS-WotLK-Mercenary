...
MD5::MD5( unsigned char *string,unsigned int string_length )
{
	init();
	update(string,string_length);
	finalize();
}

MD5::MD5( const char *string,unsigned int string_length )
{
	init();
	update((unsigned char*)string,string_length);
	finalize();
}
