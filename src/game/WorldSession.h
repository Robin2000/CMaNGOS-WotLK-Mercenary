...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    public:
        ...
        void BuildListAuctionItems(tbb::concurrent_vector<AuctionEntry*> const& auctions, WorldPacket& data, std::wstring const& searchedname, uint32 listfrom, uint32 levelmin,
