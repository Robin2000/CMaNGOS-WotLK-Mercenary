...
const static int emoteHappy[6] = { 4, 10, 400, 21, 22, 71 }; //4高兴，顺序举高左右手欢呼10和400舞蹈11大笑19学鸡叫21拍手，带声音22昂首呼叫无声71高兴跳起来
const static int emoteSad[3] = { 18,391, 20 }; //18悲伤地哭泣 391仰天长啸，无声,痛苦悲伤20单膝跪下，双手举过头，求饶状
const static int emoteNormal[2] = { 1, 92 }; //1说话2弯腰行礼3挥动左手5双手抬起，做解释说明状,询问问题时的样子 92打哈欠
...
const static int emoteDefence[7] = { 39, 43, 274, 389, 433 ,14,385};//39 格挡动作43 缩头防御动作274 摆手不同意NO,389 滚开的动作,433 准备战斗,14 鄙视，粗鲁无礼，伸手抓自己屁股385 抬枪瞄准
...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
		...
		bool AddMountSpellAura(int spellid);//坐骑功能
