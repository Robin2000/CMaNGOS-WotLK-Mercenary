...
bool LoginQueryHolder::Initialize()
{
	...
	res &= SetPQuery(PLAYER_LOGIN_QUERY_CHARACTEREXT, "SELECT consumetime,mapid,coord_x,coord_y,coord_z,orientation,firstQuestChecked,disableFindPath FROM jf_character_ext WHERE guid = '%u'", m_guid.GetCounter());
...
void WorldSession::HandlePlayerLogin(LoginQueryHolder* holder)
{
    ...
    // Send MOTD
    {
		...
		std::string &str_motd = pCurrChar->context.gamePointMgr.nextGameTip();
