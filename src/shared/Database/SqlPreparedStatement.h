...
class MANGOS_DLL_SPEC SqlStatement
{
    public:
		...
		template<typename ParamType1, typename ParamType2, typename ParamType3, typename ParamType4, typename ParamType5, typename ParamType6, typename ParamType7>
		bool PExecute(ParamType1 param1, ParamType2 param2, ParamType3 param3, ParamType4 param4, ParamType5 param5, ParamType6 param6, ParamType7 param7)
		{
			arg(param1);
			arg(param2);
			arg(param3);
		...
		template<typename ParamType1, typename ParamType2, typename ParamType3, typename ParamType4, typename ParamType5, typename ParamType6, typename ParamType7, typename ParamType8>
		bool PExecute(ParamType1 param1, ParamType2 param2, ParamType3 param3, ParamType4 param4, ParamType5 param5, ParamType6 param6, ParamType7 param7, ParamType8 param8)
		{
			arg(param1);
			arg(param2);
			arg(param3);
		...
		template<typename ParamType1, typename ParamType2, typename ParamType3, typename ParamType4, typename ParamType5, typename ParamType6, typename ParamType7, typename ParamType8, typename ParamType9>
		bool PExecute(ParamType1 param1, ParamType2 param2, ParamType3 param3, ParamType4 param4, ParamType5 param5, ParamType6 param6, ParamType7 param7, ParamType8 param8, ParamType9 param9)
		{
			arg(param1);
			arg(param2);
			arg(param3);
